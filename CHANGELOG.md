...
- Add: "Full Backup" and "Full Restore" at the top of the Saved workflows dialog. A backup holds every saved workflow, the open steps and the settings. A restore puts a backup in the place of all of them, after one question (3c5fc77, b59979c, e2620be).
