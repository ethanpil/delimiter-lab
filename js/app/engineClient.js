...
(function (root) {
  ...
  // Lets the worker drop the table and every result, when the source has no file any more.
  EngineClient.prototype.unload = function () { return this.send({ type: 'unload' }); };
